# Maning Memorial Photo Intake — 2026-05-17

Source: Satoy upload in Discord `#maning-memorial` on 2026-05-17. The same batch appeared twice in chat; this folder stores one processed copy.

| File | Working caption | Suggested use | Verification needed |
|---|---|---|---|
| `01-wedding-couple-outdoors.jpg` | Wedding portrait of Maning with bride outdoors. | Family / wedding gallery | Confirm bride is Victoria; year/location. |
...
| `09-wedding-reception-table.jpg` | Wedding reception table with bride, groom, and guests. | Family / wedding gallery | Identify guests/date/location. |
| `10-studio-wedding-portrait.jpg` | Studio wedding portrait of bride and groom. | Wedding/family feature image | Confirm date/studio/location. |
